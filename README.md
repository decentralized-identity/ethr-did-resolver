...
// since that allows you to use multiple public and private networks at the same time.
...
In production, you will most likely want the ability to resolve DIDs that are based in different ethereum networks.
To do this, you need a configuration that sets the network name or chain ID (and even the registry address) for each network.
...
const providerConfig = {
  networks: [
    ...
    { name: "myprivatenet", rpcUrl: "https://my.private.net.json.rpc.url", registry: "0xdca7ef03e98e0dc2b855be647c39abe984fcf21b" }
  ]
}
